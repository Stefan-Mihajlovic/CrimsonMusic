        ...
        if(!reduceAnimations){
            if(screen.id != "screenScrollableCat"){
                if(screen.scrollTop < 0){
                    ...
                    screen.children[2].children[1].children[0].style.opacity = (30 / (-screen.scrollTop));
                    screen.children[2].children[1].children[1].style.opacity = (30 / (-screen.scrollTop));
                    screen.children[2].children[1].children[2].style.opacity = (30 / (-screen.scrollTop));
                }else{
